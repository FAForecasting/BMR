...
class bvarm
{
    public:
        ...
        arma::cube forecast(const arma::mat& X_ext, const uint_t horizon, const bool incl_shocks);
        arma::cube forecast(const arma::mat& X_T, const arma::mat& X_ext, const uint_t horizon, const bool incl_shocks);
    ...
    private:
        ...
        arma::cube forecast_int(const arma::mat* X_T_inp, const arma::mat* X_ext_inp, const uint_t horizon, const bool incl_shocks);
